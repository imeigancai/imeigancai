...
技术栈：`STM32F407` + `LoRa` + `FreeRTOS` + `传感器融合`  

- 开发LoRaWAN自适应跳频算法，在农田复杂环境下通信成功率提升至95%  
...
技术栈：`STM32H743` + `CANopen` + `FOC算法`  

- 开发基于Hall传感器的FOC启动算法，解决电机启动抖动问题  

---

### 可穿戴健康监测设备（乾元集成电路有限公司）  
**2023.6 - 2023.9**  

技术栈：`nRF52832` + `BLE` + `自适应滤波算法`  

- 实现PPG信号动态基线消除算法，运动状态下心率检测准确率提升至89%  
